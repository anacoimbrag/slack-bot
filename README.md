...
1.  **Open the source code and start editing!**
    ...
    Open the `slack-bot` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
...
The backend for this service is hosted as a cloud functions and the code can be found in the folder `job`.